...
# ---------------------- AEGIS Bank / Counterparties ----------------------

AEGIS_ICE_BANK_NAME_GS = os.getenv("AEGIS_ICE_BANK_NAME_GS")
AEGIS_ICE_BANK_ANCIENT_NAME_GS = os.getenv("AEGIS_ICE_BANK_ANCIENT_NAME_GS")

AEGIS_ICE_BANK_NAME_MS = os.getenv("AEGIS_ICE_BANK_NAME_MS")
AEGIS_ICE_BANK_ANCIENT_NAME_MS = os.getenv("AEGIS_ICE_BANK_ANCIENT_NAME_MS")

AEGIS_ICE_BANK_NAME_SAXO = os.getenv("AEGIS_ICE_BANK_NAME_SAXO")
AEGIS_ICE_BANK_ANCIENT_NAME_SAXO = os.getenv("AEGIS_ICE_BANK_ANCIENT_NAME_SAXO")


RENAME_COUNTERPARTY_MAP = {

    # Ancient name : current name
    AEGIS_ICE_BANK_ANCIENT_NAME_GS : AEGIS_ICE_BANK_NAME_GS,
    AEGIS_ICE_BANK_ANCIENT_NAME_MS : AEGIS_ICE_BANK_NAME_MS,
